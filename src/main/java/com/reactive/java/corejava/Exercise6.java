    ...
    public static void main(String[] args) throws IOException {
        ...
        String valueFromMono =
                unresponsiveMono
                        ...
                        .doOnError(e -> System.out.println("Could not retrieve the value from unresponsiveMono within 5 seconds"))
                        .onErrorReturn("")
                        .block();
        ...
        List<String> valueFromFlux =
                unresponsiveFlux
                        .timeout(Duration.ofSeconds(5L))
                        .doOnError(e -> System.out.println("Could not retrieve the value from unresponsiveFlux within 5 seconds"))
                        .onErrorReturn("")
                        .collectList()
                        .block();
